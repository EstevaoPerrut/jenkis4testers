...
Funcionalidade: Cadastro de filmes
    ...
    Esquema do Cenario: Novo filme
        O gestor de cátalogo cadastra um novo filme através do formulário
    ...
    @erro_movie
       Esquema do Cenario: Campos obrigatórios
            O gestor de catálogo tenta cadastrat um novo filme,
            mas esquece de preencher um dos campos obrigatórios,
            o sistema exibe uma notificação para o usuário.
    ...
    @dup_movie
    Cenario: Duplicado
        O gestor de catálogo tenta cadastrar um file, porém o título
